...
nuk_game_flow(_) ->
    ...
    #{turn_number := ActualTurnNumber,
      wins := ActualWins,
      losses := ActualLosses} = nuk_game_session:get_game_state(GameSession3),
    ActualWinsAndLosses = ActualWins + ActualLosses,
    ActualWinsAndLosses = 1,
    ActualTurnNumber = 1,
    [User1] = nuk_game_session:get_players(GameSession2),
    1 = nuk_game_session:get_players_count(GameSession2),
